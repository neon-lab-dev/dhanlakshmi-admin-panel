...
import logoMedlife from "../../assets/images/Logo.svg";
        ...
        >
          ...
          <div className="flex flex-col w-full justify-center items-center place-content-center place-items-center">
            <div className=" flex w-full justify-center">
              <img
                className="lg:w-[630px] lg:h-[167px] w-[200px] h-[420px]"
                src={logoMedlife}
              />
            </div>
          ...
          <button
            ...
            className="w-full mt-6 lg:h-16 h-14 bg-[#39A803] rounded-xl disabled:opacity-60 disabled:cursor-default"
          >
            {isPending ? (
